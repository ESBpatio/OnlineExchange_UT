...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1.sendMessageResponse
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1
{
  ...
  {
    [MessageBodyMember(Name = "sendMessageResponse", Namespace = "http://s-ax-rep:80/integrationax/", Order = 0)]
