...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1.sendMessageRequest
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1
{
  ...
  {
    [MessageBodyMember(Name = "sendMessage", Namespace = "http://s-ax-rep:80/integrationax/", Order = 0)]
