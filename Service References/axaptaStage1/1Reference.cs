...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1.ResponseArg
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaStage1
{
  ...
  [DataContract(Name = "ResponseArg", Namespace = "http://s-ax-rep:80/integrationax/")]
  [Serializable]
  public class ResponseArg : IExtensibleDataObject, INotifyPropertyChanged
  {
    [NonSerialized]
