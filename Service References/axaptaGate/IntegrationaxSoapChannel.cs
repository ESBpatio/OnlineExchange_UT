...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaGate.IntegrationaxSoapChannel
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaGate
{
  ...
  public interface IntegrationaxSoapChannel : IntegrationaxSoap, IClientChannel, IContextChannel, IChannel, ICommunicationObject, IExtensibleObject<IContextChannel>, IDisposable
  {
  }
}
