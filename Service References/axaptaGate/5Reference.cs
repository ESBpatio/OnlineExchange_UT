...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaGate.sendMessageResponseBody
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaGate
{
  ...
  public class sendMessageResponseBody
  {
    ...
    public ResponceArg sendMessageResult;

    public sendMessageResponseBody()
    {
    }

    public sendMessageResponseBody(ResponceArg sendMessageResult) => this.sendMessageResult = sendMessageResult;
  }
}
