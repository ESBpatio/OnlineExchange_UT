...
// Type: ESB_ConnectionPoints.SamplePlugins.File.axaptaGate.sendMessageRequest
...
namespace ESB_ConnectionPoints.SamplePlugins.File.axaptaGate
{
  ...
  {
    [MessageBodyMember(Name = "sendMessage", Namespace = "http://sd-ax-rep1:80/integrationax/", Order = 0)]
    ...
    public sendMessageRequest(sendMessageRequestBody Body) => this.Body = Body;
  }
}
